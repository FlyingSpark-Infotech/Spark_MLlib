...
val data = spark.read.option("header","true").option("inferSchema","true").format("csv").load("file:///home/shekhar/spark_practice/spark_ml/linear_regression/USA_Housing.csv")
